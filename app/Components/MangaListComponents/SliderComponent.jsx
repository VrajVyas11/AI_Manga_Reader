          ...
          <div className="absolute inset-0 flex flex-col md:flex-row">
            <div className="relative w-full md:w-[73%] h-full overflow-hidden">
              ...
              <div className="relative h-full z-20 flex items-center justify-between">
                ...
                {/* Mobile cover */}
                <Link href={`/manga/${activeManga?.id}/chapters`} prefetch={true} onClick={() => handleMangaClicked(activeManga)} className="absolute top-[60px] right-6 md:right-3 w-[100px] h-40 md:hidden z-30 transition-all duration-500 block" style={{ boxShadow: '0 20px 40px rgba(0,0,0,0.5), 0 0 30px rgba(0,0,0,0.3)' }}>
