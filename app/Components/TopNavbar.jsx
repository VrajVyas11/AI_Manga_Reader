...
const TopNavbar = () => {
  ...
  return (
    <header
      ...
      className={`fixed backdrop-blur-sm top-0 left-0 right-0 z-[9999] w-full
        bg-gradient-to-b transition-colors duration-0
        ${isDark
          ? shouldShowNavLinks
      ...
      <div className="flex items-center">
        ...
        {shouldShowBreadCrumbs && (
          <nav
            ...
            className={`absolute text-base overflow-hidden z-[9999] flex items-center select-none px-6 py-3 rounded-xl
              ${breadcrumbs.some(
              (crumb) => crumb.name === "Chapters" || crumb.name === "Chapter"
            )
                ? "top-[20%] left-[12%]"
          ...
          >
            ...
            >
              <Compass strokeWidth={3} className="w-5 h-5 mr-2" />
            </span>
