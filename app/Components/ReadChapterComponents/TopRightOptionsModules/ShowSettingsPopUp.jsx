...
function ShowSettingsPopUp({
    ...
    return (
        <div className={`border tracking-wider absolute top-12 -left-12 rounded-2xl p-3 px-5 pb-5 min-w-[259px] backdrop-blur-xl ${isDark
            ...
            <div className="space-y-5">
                {/* Layout Direction */}
                <div>
                    <label className={`flex flex-row gap-1.5 justify-start items-center text-sm font-medium mb-2 ${isDark ? "text-white" : "text-gray-800"
                        }`}>
                            ...
                            {[true, false].map((option) => (
                                <button
                                    ...
                                    onClick={(e) => {
                                        ...
                                        e.preventDefault();
                                        e.nativeEvent?.stopImmediatePropagation();
                                       setShowTranslationTextOverlay(option)
                                    }}
                            ...
                            <button
                                key={option.toString()}
                                 onClick={(e) => {
                                        ...
                                        e.preventDefault();
                                        e.nativeEvent?.stopImmediatePropagation();
                                       setShowTranslationAndSpeakingOptions(option)
                                    }}
