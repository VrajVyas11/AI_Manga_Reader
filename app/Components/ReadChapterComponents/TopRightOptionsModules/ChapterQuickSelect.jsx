...
const ChapterQuickSelect = memo(({ 
    ...
    <div className={`absolute top-12 -left-12 border rounded-2xl backdrop-blur-xl ${
        isDark 
        ...
        <div
            ...
            className={`tracking-wider relative p-2 md:p-3 pt-0 w-48 md:w-64 max-h-64 md:max-h-80 overflow-y-auto backdrop-blur-lg rounded-2xl shadow-2xl z-50 ${
        ...
        >
            ...
            <div className={`tracking-wider sticky top-0 w-full md:-top-3 p-2 border-b ${
                isDark 
                ...
                <div className="tracking-wider w-full flex items-center gap-1.5 md:gap-2">
                    <input
                        ...
                        className={`tracking-wider flex-1 border rounded-md px-1.5 md:px-2 py-0.5 md:py-1 text-[10px] md:text-sm focus:outline-none ${
                            isDark 
                    ...
                    <button
                        ...
                        className={`tracking-wider p-0.5 md:p-1 rounded-md transition-colors ${
                            isDark 
                ...
                <div className="tracking-wider flex gap-0.5 md:gap-1 mt-0.5 md:mt-3">
                    <button
                        ...
                        className={`tracking-wider flex-1 py-0.5 md:py-1 text-[10px] md:text-xs rounded-md transition-colors ${
                            isDark 
            ...
            <div className="tracking-wider py-0.5 md:py-1">
                {filteredChapters.map((chapter) => (
                    <button
                        ...
                        className={`w-full tracking-wider text-left px-2 md:px-3 py-1.5 md:py-2 text-[10px] md:text-sm transition-colors ${
                    ...
                    >
                        ...
                        <div className={`tracking-wider text-[9px] md:text-xs flex items-center mt-0.5 ${
