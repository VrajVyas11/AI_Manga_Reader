  ...
  const renderButton = () => {
    if (!ready) {
      return layout !== "vertical" ? (
        ...
        >
          <AudioLines
            className={`tracking-wider w-10 h-10 sm:w-16 sm:h-16 group-hover:border-2 transition-all ease-in-out duration-300 rounded-full border p-2 sm:p-3 transform group-hover:rotate-[360deg] ${
              isDark
          ...
          />
          <span
            className={`absolute font-sans font-bold left-12 sm:left-20 text-[11px] sm:text-lg tracking-tight opacity-0 transform translate-x-2 sm:translate-x-4 transition-all duration-300 group-hover:opacity-100 whitespace-nowrap group-hover:translate-x-0 ${
              isDark
        ...
        >
          <AudioLines
            className={`tracking-wider w-8 h-8 sm:w-12 sm:h-12 group-hover:border-2 transition-all ease-in-out duration-300 rounded-full border p-2 sm:p-3 transform group-hover:rotate-[360deg] ${
              isDark
                ? "group-hover:border-violet-500 bg-gray-50 text-purple-800 border-gray-700"
    ...
    if (isSpeaking) {
      return (
        <button
          onClick={handleStop}
          className={`group flex items-center justify-start min-w-[36px] sm:min-w-[48px] rounded-full cursor-pointer relative overflow-hidden transition-all duration-300 shadow-[0px_0px_6px_rgba(0,0,0,1)] hover:shadow-lg disabled:cursor-not-allowed backdrop-blur-md lg:font-semibold ${
            layout == "vertical" 
              ? "h-auto p-2" 
        ...
        >
          <Square
            ...
            } group-hover:border-4 transition-all ease-in-out duration-300 rounded-full border p-2 sm:p-3 transform group-hover:rotate-[360deg] ${
              isDark
      ...
      <div className="tracking-wider flex flex-row justify-center items-center md:gap-2">
        ...
        <div className="relative z-40">
          <button
            ...
            className={`tracking-wider my-auto p-1 sm:p-2 rounded-full shadow-md transition-all duration-300 self-end mr-2 ${
              isDark
          ...
          {showControls && (
            <div className={`tracking-wider h-fit z-50 absolute right-10 md:right-10 -top-16 md:bottom-full mb-2 backdrop-blur-md rounded-lg p-3 sm:p-4 shadow-lg border w-32 sm:w-64 ${
              isDark
                ? "bg-[#1a063e] bg-opacity-90 border-violet-500"
                : "bg-purple-50 bg-opacity-90 border-purple-300"
            }`}>
              <div className="tracking-wider mb-3">
                <label className={`tracking-wider text-xs sm:text-sm block mb-1 ${
                  isDark ? "text-white" : "text-gray-700"
                }`}>
                  Voice
                </label>
                <select
                  className={`tracking-wider w-full rounded p-1 sm:p-2 border focus:outline-none text-xs ${
                    isDark
              ...
              <div>
                ...
                <input
                  ...
                  className={`tracking-wider w-full ${
                    isDark ? "accent-violet-500" : "accent-purple-500"
                  }`}
                />
              </div>
              <button
                onClick={toggleControls}
                className={`tracking-wider mt-1 md:mt-3 text-white px-3 py-1 rounded-full text-xs sm:text-sm font-medium transition-colors ${
                  isDark
        ...
        {layout !== "vertical" ? (
          ...
          >
            ...
            />
            <span
              className={`absolute font-sans ml-2 sm:ml-3 font-bold left-12 sm:left-20 text-[11px] sm:text-lg tracking-tight opacity-0 transform translate-x-2 sm:translate-x-4 transition-all duration-300 group-hover:opacity-100 group-hover:translate-x-0 ${
                isDark
                  ? "text-gray-100 group-hover:text-black"
                  : "text-gray-800 group-hover:text-black"
              }`}
          ...
          >
            <AudioLines
              className={`tracking-wider w-8 h-8 sm:w-12 sm:h-12 group-hover:border-2 transition-all backdrop-blur-lg ease-in-out duration-300 rounded-full border p-2 sm:p-3 transform group-hover:rotate-[360deg] ${
                isDark
